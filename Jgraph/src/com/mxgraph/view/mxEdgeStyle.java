/**
 * $Id: mxEdgeStyle.java,v 1.45 2011-04-20 19:59:56 david Exp $
	...
	public static mxEdgeStyleFunction orthConnector = new mxEdgeStyleFunction()
	{
				...
				mxCellState target, List<mxPoint> points, List<mxPoint> result)
		{
			if (source != null && target != null)
			{
				...
				portConstraint[0] = mxUtils.getPortConstraints(source
						.getStyle());
				portConstraint[1] = mxUtils.getPortConstraints(target
						.getStyle());
